...
export const ProductsCard3 = () => {
    ...
    return (
        <div className="px-5 md:px-8 mb-9 my-12">
            <div className="md:flex items-center justify-between">
                <div className="my-2">
                    <h3 className="font-semibold text-xl">New Arrivals</h3>
                </div>
                <div className="space-x-2 my-2 flex justify-center flex-wrap items-center md:block">
                    <button className="py-2 px-3 rounded bg-[#1BAB6E] text-white font-semibold">All</button>
                    <button className="bg-[#E1E1E1] py-2 px-3 my-2 rounded hover:bg-[#1BAB6E] hover:text-white font-semibold">Mobile</button>
                    <button className="bg-[#E1E1E1] py-2 px-3 my-2 rounded hover:bg-[#1BAB6E] hover:text-white font-semibold">Laptops</button>
                    <button className="bg-[#E1E1E1] py-2 px-3 my-2 rounded hover:bg-[#1BAB6E] hover:text-white font-semibold">Tablets</button>
                    <button className="bg-[#E1E1E1] py-2 px-3 my-2 rounded hover:bg-[#1BAB6E] hover:text-white font-semibold">Smart Watches</button>
                    <button className="bg-[#E1E1E1] py-2 px-3 my-2 rounded hover:bg-[#1BAB6E] hover:text-white font-semibold">Accessories</button>
                </div>
            </div>
